...
// ==============================================
// HeaderManager Class (with advanced shrink effect)
// ==============================================
class HeaderManager {
  constructor() {
  ...
  handleHeaderScroll() {
    ...
    // Add 'scrolled' class when above threshold for additional styling
    ...
    // Hide header on scroll down, show on scroll up (if scrolled past header height)
...
// ==============================================
// HeroManager Class (with new interactive tilt & fade animations)
// ==============================================
class HeroManager {
  constructor() {
    ...
    this.heroProduct = document.getElementById('heroProduct');
  ...
  setupProductTilt() {
    if (this.heroProduct) {
      this.heroProduct.addEventListener('mousemove', (e) => {
        ...
        const rotateY = ((x / width) - 0.5) * 20; // adjust intensity as needed
        const rotateX = ((y / height) - 0.5) * -20;
        this.heroProduct.style.transform = `rotateX(${rotateX}deg) rotateY(${rotateY}deg)`;
      });
      this.heroProduct.addEventListener('mouseleave', () => {
        this.heroProduct.style.transform = `rotateX(0deg) rotateY(0deg)`;
      });
    }
  }
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Setup performance optimizations on resize
